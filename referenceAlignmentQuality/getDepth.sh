...
sbatch getAlignmentDepth.slurm $halPath HmelDisco HmelRef coverageDepth_melpomene_discoToRef.wig coverageDepth_melpomene_refToDisco.bed
...
sbatch getAlignmentDepth.slurm $halPath HeraDisco HeraRef coverageDepth_erato_discoToRef.wig coverageDepth_melpomene_refToDisco.bed
