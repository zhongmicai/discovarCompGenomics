...
if arguments.which=='findDeletions':
    findDeletions(arguments.alignment,arguments.refGenome, arguments.ingroupList,arguments.outputFile)
    if arguments.i:
        optionList=["-wa",""]
        if arguments.wo:
            optionList[0]="-wo"
